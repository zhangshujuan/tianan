/*!
 * =====================================================
 * renhe by yangbinbin - http://m.renhe.cn/
 *
 * =====================================================
 */
	...
	************   Modals   ************
	...
	+function($) {
	    ...
	    $.initPage = function(page) {
	        ...
	        $.initPullToRefresh && $.initPullToRefresh($content);
	        $.initInfiniteScroll && $.initInfiniteScroll($content);
	        $.initCalendar && $.initCalendar($content);
